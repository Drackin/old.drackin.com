...
function Card() {
  ...
  return (
    <div
      id="card"
      className="w-full h-screen flex items-center text-white justify-center"
    >
      <div className="flex
        flex-col mobile:w-[90%] mobile:justify-center mobile:items-center w-[70%]
        rounded-xl items-center justify-center space-x-5 space-y-3">

        <div className="flex
        mobile:flex-col mobile:justify-center mobile:items-center w-full
        rounded-xl items-center justify-center space-x-5 space-y-3">
          <img

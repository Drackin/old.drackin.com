...
const Skills: NextPage = () => {
    ...
    return (
        <div className="w-full min-h-full flex-wrap flex justify-center sm:items-center">
            {skills.map((skill, index) => (
                <a
                    href={skill.url}
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center w-48 mobile:w-full shadow-[#111] shadow-md mx-3 rounded-md h-16 mobile:m-2"
                    key={index}
                >
